      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            The Complete
            <span className="block text-otto-blue">Payment Suite</span>
            for Modern Business
          </h1>

          {/* Subheadline */}
          <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
            Accept payments, manage gift cards, build loyalty programs, and scale your business with Otto's
            comprehensive payment platform. Trusted by thousands of businesses across Africa.
          </p>
          ...
          <div className="text-center mb-8">
            <p className="text-gray-600 mb-4">Download the Otto Mobile App</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://play.google.com/store/apps/details?id=com.otto.customer"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-black text-white px-6 py-3 rounded-full hover:bg-gray-800 transition-colors duration-200 font-medium text-sm flex items-center justify-center gap-2"
              >
